/* Generated By:JJTree&JavaCC: Do not edit this line. DomainTree.java */
package drctree;

public class DomainTree/*@bgen(jjtree)*/implements DomainTreeTreeConstants, DomainTreeConstants {/*@bgen(jjtree)*/
  protected JJTDomainTreeState jjtree = new JJTDomainTreeState();public static void main(String args []) throws ParseException
  {
...
// a list of variables
 ...
 boolean jjtc000 = true;
 jjtree.openNodeScope(jjtn000);String t; String list;
    try {
      list = variable();
      label_4:
      while (true) {
...
// the tables, start with table's name, and a list of all the variables of the same number of the tables columns
 ...
 boolean jjtc000 = true;
 jjtree.openNodeScope(jjtn000);Token t; String tab; String s;
    try {
    ...
    jjtree.closeNodeScope(jjtn000, true);
    jjtc000 = false;
    tab += s + ")"; jjtn000.value = tab; {if (true) return tab;}
    } catch (Throwable jjte000) {
    if (jjtc000) {
      jjtree.clearNodeScope(jjtn000);
      jjtc000 = false;
...
// the conditions for the selection
 ...
 jjtree.openNodeScope(jjtn000);Token t; String cond = ""; String s;
  ...
  public DomainTreeTokenManager token_source;
  ...
  public DomainTree(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public DomainTree(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new DomainTreeTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public DomainTree(java.io.Reader stream) {
  ...
  public DomainTree(DomainTreeTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(DomainTreeTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
